...
import img5 from "../images/ets1.png";
          ...
          <div className="cont">
            <Row className="top-img">
              ...
              <Col lg="6" className="column2">
                <div className="text-prop-head">Electronic Target System</div>
                <br />
                <div className="subtext">
                  Is an electro-mechanical, software-driven, acoustical
                  projectile detection and reporting system designed to be used
                  at outdoor ranges for live Small Arms firing. The equipment is
                  rugged, light-weight, easy to assemble and operate as per the
